...
This box-plot shows that there is not a large correlation between number of bedrooms and sale price. It would likely be better if it was included as a variable in a multiple linear regression to identify how exactly it impacts (or doesn't) impact sale price.
